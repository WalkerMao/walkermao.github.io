...
**Instead of minimizing, gradient boosting and XGBoost use the gradient descent and Newton's method respectively to do the step [2] (a) in the algorithm above.** 
