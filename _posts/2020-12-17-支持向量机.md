...
| ---------------- | -------------- | ------------- | -------------- | ---------------- | ------------------------------------------------------------ |
| $$0$$            | $$C$$          | $$0$$         | 是             | 否               | No                                                           |
| $$0<\alpha_i<C$$ | $$C-\alpha_i$$ | $$0$$         | 是             | 是               | On $$H_1$$ if $$y_i=1$$ or $$H_2$$ if $$y_i=-1$$.            |
| $$C$$            | $$0$$          | $$0<\xi_i<1$$ | 是             | 是               | No                                                           |
| $$C$$            | $$0$$          | $$1$$         | /              | 是               | On the separating hyperplane.                                |
| $$C$$            | $$0$$          | $$\xi_i>1$$   | 否             | 是               | In case $$\xi_i=2$$, on $$H_2$$ if $$y_i=1$$ or $$H_1$$ if $$y_i=-1$$. Otherwise no. |
