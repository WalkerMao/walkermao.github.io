...
$$H_1$$ and $$H_2$$ are parallel because $$H_1 \cap H_2 = \O$$. We want to make these two hyperplanes separate the data points, and also maximize the margin between them. 
