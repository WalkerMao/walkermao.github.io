...
$$
H_1 = \{x \in \mathbb{R}^p : w^Tx + b = 1\}, \\ H_2 = \{x \in \mathbb{R}^p : w^Tx + b = -1\}.
$$
...
<div align="center"> <img src="../pictures/surrogate-loss-functions.png" alt="surrogate-loss-functions.png" style="zoom:40%;" /> <div/>
...
& \text{ subject to } 
\begin{cases} 
y_i(w^Tx_i+b) \geq 1-\xi_i,  \\ \xi_i\geq0,\forall i=1,\cdots,n. 
\end{cases}
\end{aligned}
\end{equation*}
$$
