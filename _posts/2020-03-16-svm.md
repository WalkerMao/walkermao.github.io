...
<div align="center"> <img src="../pictures/svm-slack.png" alt="svm-slack.png" style="zoom:50%;" /> </div>
...
As shown below, the left plot shows that the data is not linearly separable in original feature space, while the right plot shows that the data is linearly separable in a higher dimensional feature space.
